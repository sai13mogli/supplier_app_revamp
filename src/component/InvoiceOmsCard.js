...
const InvoiceOmsCard = props => {
          ...
          <View style={styles.leftpart}>
            {invoiceImage ? (
              <ImageBackground
                ...
                <Image source={{uri: invoiceImage}} style={styles.imgStyle} />
              </ImageBackground>
            ) : (
              <ImageBackground
                source={require('../assets/images/rectanglebg.png')}
          ...
          <View style={styles.rightPart}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{marginRight: Dimension.margin20}}>
                ...
                <Text style={styles.TitleLightTxt}>
                  Total Price -{' '}
                  <Text style={styles.TitleBoldTxt}>{totalPrice}</Text>
                </Text>
              </View>

              <View>
                <Text style={styles.TitleLightTxt}>
                  TP/Unit - <Text style={styles.TitleBoldTxt}>₹{TpUnit}</Text>
                </Text>
                <Text style={styles.TitleLightTxt}>
                  Product HSN -{' '}
                  <Text style={styles.TitleBoldTxt}>{taxpercent}</Text>
                </Text>
              </View>
            </View>
          </View>
  ...
  return (
    <>
      <View style={styles.orderCardwrap}>{renderOrderDetails(false, '')}</View>
    </>
  );
};
