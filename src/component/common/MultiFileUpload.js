    ...
    <View>
      {docsList.map((doc, docKey) => (
        <View style={styles.fileOutWrap}>
          <View style={{flexDirection:"row",alignItems:"center"}}>
            ...
            <CustomeIcon name={'orders-line'} size={Dimension.font22} color={Colors.eyeIcon}></CustomeIcon>
            </View>
            <Text style={styles.DocumentName}>{doc.name}</Text>
          </View>
          
          <CustomeIcon name={'delete'} size={Dimension.font22} color={Colors.blackColor} onPress={() => onRemove(doc.id)}></CustomeIcon>
      ...
      <TouchableOpacity
        ...
        <Image
          ...
          style={{height: Dimension.height16, width:  Dimension.height16,marginLeft:Dimension.margin5}}
        />
      </TouchableOpacity>
