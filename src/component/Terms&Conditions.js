...
const TermsAndConditions = props => {
  ...
  useEffect(() => {
    const backAction = () => {
      props.route.params.setConfirmModal();
      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.wrapView}>
          ...
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(
                'https://supplier.moglix.com/files/enterprise-supplier-aggrement.pdf',
              )
            }>
        ...
        <View style={styles.wrapView}>
          ...
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(
                'https://supplier.moglix.com/files/supplier-aggrement.pdf',
              )
            }>
            <Text style={styles.terms}>Terms & Condition</Text>
          </TouchableOpacity>
        ...
        <View style={styles.wrapView}>
          ...
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(
                'https://supplier.moglix.com/files/abg-supplier-aggrement.pdf',
              )
            }>
            <Text style={styles.terms}>Terms & Condition</Text>
          </TouchableOpacity>
