        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={styles.bottombtnWrap}>
                <CustomButton
                    ...
                    buttonColor={(bulkItemIds && bulkItemIds.length) ? colors.BrandColor : colors.grayShade8}
                    borderColor={colors.transparent}
                    TextColor={(bulkItemIds && bulkItemIds.length) ? colors.WhiteColor : colors.blackColor}
