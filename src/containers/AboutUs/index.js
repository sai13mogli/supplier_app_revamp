      ...
      <Text style={styles.nrmtxt}>
        ...
        <View style={styles.rowCss}>
          ...
          <Text style={styles.nrmtxt}>
            ...
            address, and mandatory Documents. </Text>
        </View>
        <View style={styles.rowCss}>
          <View style={styles.bullet}></View>
          <Text style={styles.nrmtxt}>
          Our team will verify your profile
        ...
        <View style={styles.rowCss}>
          <View style={styles.bullet}></View>
          <Text style={styles.nrmtxt}>
          Now you are ready to start receiving orders from us – view order summary and track
        ...
        <View style={styles.rowCss}>
          <View style={styles.bullet}></View>
        <Text style={styles.nrmtxt}>
        If you are an <Text style={{ color: 'blue' }}> enterprise Supplier </Text>you can
        ...
        <View style={styles.rowCss}>
          <View style={styles.bullet}></View>
        <Text style={styles.nrmtxt}>
         You have the option to switch between enterprise and online
        business view by a simple toggle.
        </Text>
        </View>
        <View style={styles.rowCss}>
          <View style={styles.bullet}></View>
        <Text style={styles.nrmtxt}>Raise a ticket from the Support tab if
        ...
        <Text style={styles.nrmtxt}>
        You can as
        well view the status of your tickets and respond accordingly.
        </Text>
        </View>
        <View style={styles.rowCss}>
          <View style={styles.bullet}></View>
